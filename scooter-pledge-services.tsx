...
import { Bike, DollarSign, Clock, Shield, FileText, Percent, CheckCircle2, Menu, Phone, Mail, MapPin, Facebook, Instagram, Twitter, Linkedin, Car, X } from 'lucide-react'
...
export default function ScooterPledgeServices() {
...
const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
  ...
  const whatsappMessage = `New Scooter Loan Application:
Name: ${name}
Phone: ${phone}
Email: ${email}
Message: ${message}`
          ...
          <div className="flex items-center">
            ...
            <NavigationMenu className="hidden md:flex ml-6">
              <NavigationMenuList className="space-x-4">
                <NavigationMenuItem>
                  <Link href="/" className="text-base font-medium hover:text-red-500 transition-colors">Home</Link>
                </NavigationMenuItem>
                <NavigationMenuItem>
    ...
    <main className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="mb-16">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <h1 className="text-3xl md:text-4xl font-bold mb-6 text-red-600">Scooter Pledge Loan Services in Bangalore</h1>
            <p className="text-xl text-gray-700 mb-8">Quick, convenient, and hassle-free financing for your scooter. Get the funds you need without giving up your ride.</p>
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-6 text-red-600">Understanding Scooter Pledge Loans</h2>
        <p className="text-gray-700 mb-4">
          A scooter pledge loan is a secured loan where you use your scooter as collateral. This type of loan provides a quick and easy way to access funds without selling your vehicle. At Shree Lakshmi Pawn Brokers, we specialize in offering hassle-free scooter pledge loans in Bangalore, catering to the diverse financial needs of scooter owners.
        </p>
        <p className="text-gray-700 mb-4">
          Our scooter pledge loan service is designed to offer you financial flexibility while ensuring the safety and security of your vehicle. Whether you need funds for an emergency, personal expenses, or any other purpose, our loan process is streamlined to provide you with quick access to cash without the lengthy approval processes associated with traditional loans.
        </p>
        <Card className="bg-white border-red-800">
          <CardHeader>
            <CardTitle className="flex items-center text-red-600">
              <Bike className="mr-2 h-6 w-6" />
              Scooter Pledge Loan Features
            </CardTitle>
            <CardDescription className="text-gray-700">Discover the benefits of our scooter pledge loans</CardDescription>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2">
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
                Loan up to 70% of your scooter's value
              </li>
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
                Competitive interest rates starting from 4.5% per month
              </li>
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
                Flexible repayment terms up to 18 months
              </li>
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
              ...
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
                Secure storage of your scooter during the loan period
              </li>
            </ul>
          </CardContent>
        </Card>
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-white border-red-800">
            ...
            <CardContent>
              <p className="text-sm text-gray-700">We don't perform credit checks. Our loans are based solely on your scooter's value, making it easier for you to get financial assistance regardless of your credit history.</p>
            </CardContent>
          </Card>
          <Card className="bg-white border-red-800">
            <CardHeader>
          ...
          <Card className="bg-white border-red-800">
            ...
            <CardContent>
              <p className="text-sm text-gray-700">Enjoy some of the most competitive interest rates in the market, ensuring that you get the best value for your scooter pledge. Our transparent pricing means no surprises.</p>
            </CardContent>
          </Card>
        </div>
      </section>
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-semibold mb-6 text-red-600">Our Scooter Pledge Loan Process</h2>
        <p className="text-gray-700 mb-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: FileText, title: "Apply", description: "Fill out our simple online or in-person application with basic details about you and your scooter." },
            { icon: Bike, title: "Evaluate", description: "Our experts assess your scooter's current market value to determine the maximum loan amount." },
            { icon: DollarSign, title: "Approve", description: "Get instant approval and a competitive loan offer based on your scooter's value." },
      ...
      <section className="mb-16">
        ...
        <ul className="list-disc pl-6 mb-6 text-gray-700">
          <li>You must be the legal owner of the scooter</li>
          <li>The scooter should be in good condition and roadworthy</li>
        ...
        <Card className="bg-white border-red-800">
          <CardContent className="pt-6">
            <ul className="space-y-2">
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
                Original RC (Registration Certificate) of the scooter
              </li>
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
              ...
              <li className="flex items-center">
                <CheckCircle2 className="mr-2 h-4 w-4 text-red-500" />
                NOC (No Objection Certificate) from the financier (if the scooter was purchased on loan)
              </li>
            </ul>
          </CardContent>
        </Card>
      ...
      <section className="mb-16">
        ...
        <p className="text-gray-700 mb-4">
          We understand that you may have questions about our scooter pledge loan services. Here are answers to some of the most common queries we receive:
        </p>
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1" className="border-red-800">
            <AccordionTrigger className="text-red-600">How much loan can I get against my scooter?</AccordionTrigger>
            <AccordionContent className="text-gray-700">
              You can get a loan of up to 70% of your scooter's current market value. The exact amount depends on factors such as the vehicle's age, condition, and market demand. Our expert evaluators will assess your scooter to determine the maximum loan amount you're eligible for.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-2" className="border-red-800">
            <AccordionTrigger className="text-red-600">What happens to my scooter during the loan period?</AccordionTrigger>
            <AccordionContent className="text-gray-700">
              Your scooter will be securely stored in our designated parking facility. We ensure its safety and proper maintenance throughout the loan period. Our storage facilities are equipped with 24/7 security and protection against environmental factors to keep your scooter in the same condition as when you pledged it.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem value="item-3" className="border-red-800">
            ...
            <AccordionContent className="text-gray-700">
              Yes, you can repay the loan at any time before the due date. We do not charge any prepayment penalties, so you can clear your loan whenever you're ready. Early repayment can help you save on interest charges and get your scooter back sooner.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-5" className="border-red-800">
            ...
            <AccordionContent className="text-gray-700">
              No, we do not perform credit checks. Our loans are based on the value of your scooter, making it easier for you to get financial assistance regardless of your credit history. This makes our scooter pledge loans an excellent option for those who may have difficulty obtaining traditional loans due to credit issues.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 mb-4">
          If you're in need of quick financial assistance and own a scooter, our pledge loan service could be the perfect solution for you. With competitive rates, a simple application process, and fast approval, we're here to help you overcome your financial challenges.
        </p>
        <Card className="bg-red-900 text-white border-red-800">
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-4 md:mb-0">
                <h3 className="text-xl font-semibold mb-2 text-white">Apply for a Scooter Pledge Loan Today</h3>
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-700">Shree Lakshmi Pawn Brokers offers hassle-free vehicle financing solutions for scooters and two-wheelers with competitive rates and quick approvals in Bangalore. With years of experience, we've become a trusted name in scooter pledge loans, providing our customers with reliable and efficient financial services.</p>
          </div>
          <div>
    ...
    {isPopupOpen && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-8 max-w-md w-full">
          <h2 className="text-2xl font-bold mb-4 text-red-600">Apply for a Scooter Loan</h2>
