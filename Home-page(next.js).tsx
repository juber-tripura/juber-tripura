...
export default function Home() {
  ...
  const slides = [
    { image: "/vehicle-1.jpg", alt: "Car Loan" },
    { image: "/vehicle-2.jpg", alt: "Bike Loan" },
    { image: "/vehicle-3.jpg", alt: "Scooter Loan" },
  ]
  ...
  return (
    <>
      <NextSeo
        title="Shree Lakshmi Pawn Brokers - Quick Vehicle Loans in Bangalore"
        description="Get instant vehicle loans in Bangalore. Low interest rates, quick approval, and flexible repayment options for cars, bikes, and scooters."
        canonical="https://www.shreelakshmipawnbrokers.com/"
        openGraph={{
          url: 'https://www.shreelakshmipawnbrokers.com/',
          title: 'Shree Lakshmi Pawn Brokers - Quick Vehicle Loans in Bangalore',
          description: 'Get instant vehicle loans in Bangalore. Low interest rates, quick approval, and flexible repayment options for cars, bikes, and scooters.',
          images: [
            {
              ...
              width: 1200,
              height: 630,
              alt: 'Shree Lakshmi Pawn Brokers',
            },
          ],
      ...
      <div className="flex min-h-screen w-full flex-col bg-gradient-to-b from-gray-900 to-black text-white">
        {/* Navigation */}
        <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled ? 'bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-md' : 'bg-transparent'}`}>
                      ...
                      <CarouselItem key={index}>
                        <Card className="border-0 shadow-xl overflow-hidden">
                          <CardContent className="p-0">
                            <Image src={slide.image} alt={slide.alt} width={600} height={400}
