...
import { Bike, DollarSign, Clock, Shield, FileText, Percent, CheckCircle2, Menu, Phone, Mail, MapPin, Facebook, Instagram, Twitter, Linkedin, Ban, FileCheck, PiggyBank, Car, X, ArrowUp } from 'lucide-react'
...
Message: ${message}`
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <NextSeo
        title="Two-Wheeler Pledge Loan Services in Bangalore | Shree Lakshmi Pawn Brokers"
        description="Get fast, secure, and hassle-free two-wheeler pledge loans in Bangalore. Low interest rates, quick approval, and flexible repayment options for bikes and scooters."
        canonical="https://www.shreelakshmipawnbrokers.com/two-wheeler-pledge-loans"
        openGraph={{
          url: 'https://www.shreelakshmipawnbrokers.com/two-wheeler-pledge-loans',
          title: 'Two-Wheeler Pledge Loan Services in Bangalore | Shree Lakshmi Pawn Brokers',
          description: 'Get fast, secure, and hassle-free two-wheeler pledge loans in Bangalore. Low interest rates, quick approval, and flexible repayment options for bikes and scooters.',
          images: [
            {
              url: 'https://www.shreelakshmipawnbrokers.com/og-image.jpg',
              width: 1200,
              height: 630,
              alt: 'Shree Lakshmi Pawn Brokers Two-Wheeler Pledge Loans',
            },
          ],
          site_name: 'Shree Lakshmi Pawn Brokers',
        }}
        twitter={{
          handle: '@ShreeLakshmiPB',
          site: '@ShreeLakshmiPB',
      ...
      {/* Navigation */}
      <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled ? 'bg-white bg-opacity-90 backdrop-blur-md shadow-md' : 'bg-transparent'}`}>
            ...
            <div className="flex items-center">
              ...
              <NavigationMenu className="hidden md:flex ml-6">
                <NavigationMenuList className="space-x-4">
                  <NavigationMenuItem>
                    <NavigationMenuLink className="text-base font-medium hover:text-red-500 transition-colors" onClick={() => scrollToSection('home')}>Home</NavigationMenuLink>
                  </NavigationMenuItem>
                  <NavigationMenuItem>
                    ...
                    <NavigationMenuContent>
                      <div className="grid w-[400px] gap-3 p-4 bg-gray-950 text-white rounded-lg">
                        <NavigationMenuLink className="flex items-center space-x-2 rounded-md p-3 hover:bg-red-800 transition-colors" onClick={() => scrollToSection('two-wheeler-loans')}>
                  ...
                  <NavigationMenuItem>
                    <NavigationMenuLink className="text-base font-medium hover:text-red-500 transition-colors" onClick={() => scrollToSection('contact-us')}>Contact</NavigationMenuLink>
                  </NavigationMenuItem>
                </NavigationMenuList>
              </NavigationMenu>
            </div>
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="#home" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:text-white hover:bg-red-800" onClick={() => scrollToSection('home')}>Home</a>
                <a href="#two-wheeler-loans" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:text-white hover:bg-red-800" onClick={() => scrollToSection('two-wheeler-loans')}>Two-Wheeler Pledge Loan</a>
                <a href="#about-us" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:text-white hover:bg-red-800" onClick={() => scrollToSection('about-us')}>About Us</a>
                <a href="#contact-us" className="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:text-white hover:bg-red-800" onClick={() => scrollToSection('contact-us')}>Contact</a>
              </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section id="two-wheeler-loans" className="mb-16">
        ...
        <section id="about-us" className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-red-600">About Shree Lakshmi Pawn Brokers</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gray-700 mb-4">
                Shree Lakshmi Pawn Brokers has been a trusted name in Bangalore's financial services sector for over two decades. We specialize in providing quick and hassle-free two-wheeler pledge loans to meet the diverse financial needs of our customers.
              </p>
              <p className="text-gray-700 mb-4">
                Our commitment to transparency, competitive rates, and customer satisfaction has made us a preferred choice for individuals seeking immediate financial assistance. With a team of experienced professionals and a streamlined loan process, we ensure that you get the support you need when you need it the most.
              </p>
            </div>
            <div>
              <Image
                src="/placeholder.svg?height=300&width=400"
                alt="Shree Lakshmi Pawn Brokers Office"
                width={400}
                height={300}
                className="rounded-lg shadow-lg"
              />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="#home" className="text-sm text-gray-700 hover:text-red-500 transition-colors">Home</Link></li>
                <li><Link href="#about-us" className="text-sm text-gray-700 hover:text-red-500 transition-colors">About Us</Link></li>
                <li><Link href="#two-wheeler-loans" className="text-sm text-gray-700 hover:text-red-500 transition-colors">Services</Link></li>
                <li><Link href="#contact-us" className="text-sm text-gray-700 hover:text-red-500 transition-colors">Contact Us</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4 text-red-600">Our Services</h3>
              <ul className="space-y-2">
                <li><Link href="#two-wheeler-loans" className="text-sm text-gray-700 hover:text-red-500 transition-colors">Two-Wheeler Pledge Loan</Link></li>
